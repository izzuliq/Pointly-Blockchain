    ...
    <>
      ...
      <div className="p-6 bg-white shadow-md rounded-lg">
        ...
        <p className="mt-2 text-gray-600">
          Track your activities and points here.
        </p>
          ...
          <ul className="mt-4 space-y-4">
            <li className="flex justify-between bg-gray-50 p-4 rounded-lg shadow-sm">
              <span className="text-gray-700">
                Earned 100 points from a purchase
              </span>
              <span className="text-gray-500">2 hours ago</span>
            </li>
            <li className="flex justify-between bg-gray-50 p-4 rounded-lg shadow-sm">
              <span className="text-gray-700">
                Redeemed 200 points for a reward
              </span>
              <span className="text-gray-500">1 day ago</span>
            </li>
            <li className="flex justify-between bg-gray-50 p-4 rounded-lg shadow-sm">
              <span className="text-gray-700">
                Earned 50 points from a review
              </span>
        ...
        <div className="mt-8">
          ...
          <div className="mt-4 bg-gray-50 p-4 rounded-lg shadow-sm">
            ...
            <div className="h-4 bg-purple-200 rounded-lg">
              <div
                className="h-4 bg-purple rounded-lg"
                style={{ width: "50%" }}
              ></div>
            </div>
            <p className="mt-2 text-gray-500 text-sm">
              50% to your next reward
            </p>
          </div>
        </div>
      </div>
