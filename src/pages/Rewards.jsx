  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-lg">
      ...
      <div className="mt-8">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg shadow-md flex flex-col items-center">
            ...
            <p className="mt-2 text-gray-600 text-center">Enjoy a freshly brewed cup of coffee with your reward points.</p> {/* Description */}
            <button className="mt-4 w-full bg-gold-dark text-white py-2 rounded-lg">Redeem</button>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-md flex flex-col items-center">
            ...
            <p className="mt-2 text-gray-600 text-center">Redeem your points for a gift voucher to use in participating stores.</p> {/* Description */}
            <button className="mt-4 w-full bg-gold-dark text-white py-2 rounded-lg">Redeem</button>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-md flex flex-col items-center">
            ...
            <p className="mt-2 text-gray-600 text-center">Unlock exclusive discounts on your next purchase with this reward.</p> {/* Description */}
            <button className="mt-4 w-full bg-gold-dark text-white py-2 rounded-lg">Redeem</button>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 text-center">
        <button className="bg-purple text-white py-2 px-6 rounded-lg">Proceed to Redeem</button>
      </div>
    </div>
  );
}
